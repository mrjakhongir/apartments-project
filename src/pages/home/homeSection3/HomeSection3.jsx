      ...
      <section className='home__section3'>
        <div className='wrapper'>
          ...
          >
            ...
            <p>
              Будучи ведущим Real-estate агентством и самостоятельным
              девелопером на острове, группа компаний Reiwa насчитывает
              20-летний опыт работы в сфере консалтинга и недвижимости на Кипре.
            </p>
          </motion.div>
        </div>
      </section>
