  ...
  return (
    <section className="home__section5">
      <div className="wrapper">
        ...
        <p>
          <strong>Reiwa</strong> имеет собственного представителя, действующего
          от имени компании и представляющего ее интересы на территории РУз. Его
          деятельность предполагает информационную поддержку и техническое
          сопровождение потенциальных инвесторов на этапе знакомства с
          недвижимостью.
        </p>
        <p>
          <strong>
        ...
        <p>
          <strong>Помощь в планировании и организации поездки на Кипр:</strong>
          <ul>
        ...
        <p>
          <strong>
            Организация онлайн и персональных встреч потенциальных покупателей с
            юристами и официальными представителями кипрской стороны:
          </strong>
          <ul>
            <li>
              ⁃ выбор оптимальной платформы и времени встречи для обеих сторон;
            </li>
            <li>
